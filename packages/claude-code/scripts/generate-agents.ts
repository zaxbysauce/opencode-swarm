...
const AGENT_CONFIGS: AgentConfig[] = [
    {
        ...
        description: 'Orchestrates the swarm — plans tasks, delegates to specialists, runs QA gates.',
        tools: ['Read', 'Glob', 'Grep', 'Bash', 'Task', 'mcp__opencode-swarm__save_plan', 'mcp__opencode-swarm__update_task_status'],
        model: 'claude-sonnet-4-6',
        color: '#FF6B6B',
        prompt: 'See packages/claude-code/agents/swarm-architect.md for full prompt.',
    },
    {
        name: 'swarm-coder',
        description: 'Implements code changes — reads files, writes code, follows specifications exactly.',
    ...
    {
        name: 'swarm-reviewer',
        description: 'Reviews code for correctness, security, and quality. Returns APPROVED or REJECTED.',
        tools: ['Read', 'Glob', 'Grep'],
        model: 'claude-sonnet-4-6',
        color: '#45B7D1',
        prompt: 'See packages/claude-code/agents/swarm-reviewer.md for full prompt.',
    },
    {
        ...
        model: 'claude-sonnet-4-6',
        color: '#96CEB4',
        prompt: 'See packages/claude-code/agents/swarm-test-engineer.md for full prompt.',
    },
    {
        name: 'swarm-critic',
        description: 'Reviews implementation plans for completeness, feasibility, and scope.',
        tools: ['Read', 'Glob', 'Grep'],
        model: 'claude-sonnet-4-6',
        color: '#FFEAA7',
    ...
    {
        name: 'swarm-explorer',
        description: 'Analyzes codebases — maps structure, identifies patterns, finds relevant files.',
        tools: ['Read', 'Glob', 'Grep', 'Bash'],
        model: 'claude-sonnet-4-6',
        color: '#DDA0DD',
        prompt: 'See packages/claude-code/agents/swarm-explorer.md for full prompt.',
    },
    {
        name: 'swarm-sme',
    ...
    },
    {
        ...
        model: 'claude-sonnet-4-6',
        color: '#BB8FCE',
        prompt: 'See packages/claude-code/agents/swarm-designer.md for full prompt.',
    },
];
