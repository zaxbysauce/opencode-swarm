...
describe('KnowledgeConfigSchema', () => {
	describe('default values', () => {
		it('should produce all 21 defaults when parsing empty object', () => {
	...
	describe('custom values', () => {
		it('should succeed when parsing a full config with all fields set', () => {
			const fullConfig = {
				...
				schema_version: 2,
				same_project_weight: 2.0,
				cross_project_weight: 0.75,
				min_encounter_score: 0.2,
				initial_encounter_score: 2.0,
				encounter_increment: 0.15,
				max_encounter_score: 15.0,
			};
