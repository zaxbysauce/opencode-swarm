...
import { swarmState, resetSwarmState, startAgentSession, ensureAgentSession, type AgentSessionState } from '../../src/state.js';
...
describe('Snapshot Integration', () => {
	...
	function makeMockSession(): AgentSessionState {
		return {
			agentName: 'mega',
			lastToolCallTime: 0,
