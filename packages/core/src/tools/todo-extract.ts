...
export function validateTagsInput(tags: string): string | null {
...
export function validatePathsInput(
	paths: string,
	cwd: string,
...
// Simple regex escape function (avoiding import from utils)
function escapeRegex(str: string): string {
	return str.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
}

export function parseTodoComments(
	content: string,
	filePath: string,
	tagsSet: Set<string>,
): TodoEntry[] {
...
export async function executeTodoExtract(
	args: TodoExtractArgs,
	cwd: string,
): Promise<string> {
