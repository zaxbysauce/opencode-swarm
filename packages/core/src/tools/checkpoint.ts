 ...
 */
export function handleSave(label: string, directory: string): string {
	try {
 ...
 */
export function handleRestore(label: string, directory: string): string {
	try {
		// Find the checkpoint
		const log = readCheckpointLog(directory);
 ...
 */
export function handleDelete(label: string, directory: string): string {
	try {
		const log = readCheckpointLog(directory);
