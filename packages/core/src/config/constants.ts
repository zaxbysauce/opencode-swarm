...
// Compatibility export for DEFAULT_MODELS - maps agent names to default model IDs
// Used by adversarial-detector.ts and OpenCode adapter
export const DEFAULT_MODELS: Record<string, string> = {
	explorer: 'claude-sonnet-4-20250514',
	coder: 'claude-sonnet-4-20250514',
	reviewer: 'claude-sonnet-4-20250514',
	test_engineer: 'claude-sonnet-4-20250514',
	sme: 'claude-sonnet-4-20250514',
