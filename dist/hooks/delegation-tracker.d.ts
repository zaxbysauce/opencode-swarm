 ...
 */
export declare function createDelegationTrackerHook(directoryOrConfig?: string | PluginConfig, configOrGuardrails?: PluginConfig | boolean, directory?: string): (input: {
    sessionID: string;
    agent?: string;
