...
describe('getAgentConfigs model stripping for primary agents', () => {
    describe('default swarm (no prefix)', () => {
        ...
        it('subagents keep model property', () => {
            ...
            const subagentNames = ['coder', 'reviewer', 'explorer', 'sme', 'critic', 'test_engineer', 'docs'];
    ...
    describe('edge cases', () => {
        it('multiple swarms: each architect loses model, all subagents keep model', () => {
            ...
            const architectNames = ['architect', 'cloud_architect', 'local_architect'];
            ...
            const subagentNames = [
                'coder', 'reviewer', 'explorer', 'sme', 'critic', 'test_engineer', 'docs',
                'cloud_coder', 'cloud_reviewer', 'cloud_explorer', 'cloud_sme', 'cloud_critic', 'cloud_test_engineer', 'cloud_docs',
                'local_coder', 'local_reviewer', 'local_explorer', 'local_sme', 'local_critic', 'local_test_engineer', 'local_docs'
            ];
            for (const name of subagentNames) {
                const agent = configs[name];
                expect(agent.mode).toBe('subagent');
