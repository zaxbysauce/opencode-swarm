...
describe('AGENT_TOOL_MAP', () => {
    ...
    it('coder lacks QA-only helpers', () => {
        ...
        const qaHelpers = ['test_runner', 'pkg_audit', 'secretscan', 'pre_check_batch', 'complexity_hotspots'];
    ...
    it('architect has all critical tools', () => {
        ...
        const criticalTools = ['diff', 'lint', 'pre_check_batch', 'secretscan', 'test_runner'];
