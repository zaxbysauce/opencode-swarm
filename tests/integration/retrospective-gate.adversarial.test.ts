...
describe('retrospective gate adversarial tests', () => {
    ...
    function writeValidBundle(phase: number, modifications: Record<string, unknown> = {}): void {
        const evidence = {
            schema_version: '1.0.0',
            task_id: `retro-${phase}`,
            entries: [{ ...validEntry, ...modifications, task_id: `retro-${phase}`, phase_number: phase }],
